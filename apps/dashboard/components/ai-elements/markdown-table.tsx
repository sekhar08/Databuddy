...
export const MdTable = ({ className, children, node: _, ...props }: ElementProps) => (
	<table className={cn("w-full text-xs", className)} {...props}>
		{children}
	</table>
);

export const MdThead = ({ className, children, node: _, ...props }: ElementProps) => (
	<thead className={cn("bg-muted/30", className)} {...props}>
		{children}
	</thead>
);

export const MdTh = ({ className, children, node: _, ...props }: ElementProps) => (
	<th
		className={cn(
...
export const MdTbody = ({ className, children, node: _, ...props }: ElementProps) => (
	<tbody className={cn("divide-y", className)} {...props}>
		{children}
	</tbody>
);

export const MdTd = ({ className, children, node: _, ...props }: ElementProps) => (
	<td
		className={cn(
